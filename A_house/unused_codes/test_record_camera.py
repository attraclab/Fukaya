...
out = cv2.VideoWriter('out.mp4',cv2.VideoWriter_fourcc(*'mp4v'), 5, (frame_width,frame_height))
...
while True:
	...
	# cv2.imshow("testWebcam", cv2.resize(image, (1280,720), interpolation=cv2.INTER_AREA))
	out.write(image)
	k = cv2.waitKey(1)
